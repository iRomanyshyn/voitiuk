...
image_caption: "Anna Voitiuk, Sightseeing Tour, 2020. Etching and aquatint (C3+C5)."
...
This is why an original print is not a reproduction of a finished painting. The printing matrix is conceived as part of the artwork, and the impression pulled from it is the work. A matrix can yield an edition, but hand inking and wiping, the changing condition of the plate and the paper introduce subtle differences between impressions. Museums group the principal ways of transferring such images into relief, intaglio and planographic printing.<sup><a href="#source-vam-what-is-print">[1]</a></sup>

## Intaglio: ink hidden below the surface

The word *intaglio* describes the process quite literally: the image sits in recessed lines and textures, usually in a metal plate. Ink is worked into those recesses and carefully wiped from the smooth surface. Damp paper is laid on top, and plate and paper pass through a roller press under considerable pressure. The softened paper reaches into the grooves and lifts ink from places a surface roller could never touch.<sup><a href="#source-met-print-history">[2]</a></sup>

It is almost the reverse of a rubber stamp. A stamp prints what projects; an intaglio plate prints what lies below. A slight embossed edge can often be seen around the finished image. It is not a frame drawn by the artist, but the physical record of metal, paper and press meeting one another.

The process can be pictured in five stages:

1. Lines, dots or tonal areas are made in a plate.
2. Printing ink is pushed into those recesses.
3. The surface is wiped, leaving ink mainly below its surface.
4. Damp paper is laid over the plate.
5. The press transfers the image under pressure.

> The sheet is not individually “coloured in”. Ink is applied to the printing matrix, from which the impression is transferred under pressure.

## Etching: the needle draws, the mordant deepens

For an etching, a metal plate is covered with an acid-resistant ground. The artist draws through it with a needle, exposing the metal wherever a line is wanted. The plate is then placed in a mordant, which acts only on the open areas and bites the drawing into the plate. Different biting times and successive stages can produce a wide range of lines.
...
In older etching practice, copper and zinc plates were often bitten with nitric acid or more complex acid mixtures. When nitric acid reacts with metal, it can release toxic nitrogen oxides, including brown nitrogen dioxide. This gas strongly irritates the lungs, while its odour may not provide an adequate warning of a dangerous concentration. Vapour and splashes can cause chemical burns to the skin and eyes; inhalation can injure the respiratory tract, and substantial or repeated exposure has been associated with bronchitis and chemical pneumonitis.<sup><a href="#source-kent-printmaking-safety">[3]</a></sup><sup><a href="#source-pubchem-nitric-acid">[4]</a></sup>

Today many workshops use **ferric chloride, or iron(III) chloride**, for copper plates. It is a corrosive salt rather than an acid and has largely replaced nitric acid and Dutch mordant in contemporary copper etching. Ferric chloride itself has negligible volatility and does not generate hazardous nitrogen oxides during ordinary copper etching, removing the particular inhalation risk created by those fumes.<sup><a href="#source-usask-safer-intaglio">[5]</a></sup>

“Safer”, however, does not mean harmless. Ferric chloride solution is acidic and corrosive: contact can damage skin and especially the eyes, while dust from the dry substance or an aerosol can irritate the respiratory tract.<sup><a href="#source-pubchem-ferric-chloride">[6]</a></sup> Splash goggles, suitable gloves, ventilation and the safety data sheet for the particular product still matter. Once copper has accumulated in the used bath, it should not be poured down a drain; it must be handled as hazardous waste through an appropriate disposal route.<sup><a href="#source-usask-safer-intaglio">[5]</a></sup>
...
European printmaking expanded rapidly in the late fourteenth and fifteenth centuries as paper became more readily available. Woodcuts came first; prints from engraved metal plates appeared around the middle of the fifteenth century. Etching grew out of the armourer’s practice of decorating metal with mordants. Between the late fifteenth and early sixteenth centuries, this workshop method became a medium for artists.<sup><a href="#source-met-renaissance-etching">[7]</a></sup>

Daniel Hopfer of Augsburg was among its early practitioners, and Albrecht Dürer experimented with the process. In the seventeenth century, Rembrandt turned etching and drypoint into an extraordinarily flexible language. He altered his plates, varied the wiping and printed distinct states of the same image. About three hundred etchings and drypoints by him are known.<sup><a href="#source-met-rembrandt-prints">[8]</a></sup>

Giovanni Battista Piranesi built monumental architectural worlds in etching. Francisco Goya combined etching with aquatint in cycles where sharp satire meets dark visions of war and human cruelty.<sup><a href="#source-met-goya-graphic">[9]</a></sup> In the nineteenth century, artists including Édouard Manet, Edgar Degas, Camille Pissarro, Mary Cassatt and James McNeill Whistler embraced original printmaking. In the twentieth, Pablo Picasso moved freely between etching, lithography and linocut.

The point of this history is not simply to assemble famous names. It shows that printmaking was never only a device for “making more copies”. For each of these artists, process became a distinct way of thinking.

## Shevchenko, not only the poet

Taras Shevchenko is read so often as a poet that his professional life as an artist can recede into the background. Yet he trained at the Imperial Academy of Arts in Saint Petersburg, pursued printmaking seriously and hoped to develop it in Ukraine.

In 1844 he published **Picturesque Ukraine**, an album of six etchings showing landscapes, scenes of everyday life and episodes from Ukrainian history.<sup><a href="#source-encyclopedia-picturesque-ukraine">[10]</a></sup> It was conceived not as an isolated image but as a coherent publication: through an edition of prints, Shevchenko could bring images of Ukraine to a wider public.

After returning from exile, he worked intensively on etchings, including portraits and interpretations of paintings. On 4 September 1860, the Council of the Academy of Arts awarded him the title of Academician of Engraving.<sup><a href="#source-nbuv-shevchenko-academician">[11]</a></sup> The National Museum of Taras Shevchenko also emphasises his innovation in socially engaged graphic art.<sup><a href="#source-shevchenko-museum-collection">[12]</a></sup>
...
The Latin phrase *ex libris* means “from the books of”. Traditionally, a bookplate is a small label bearing the owner’s name or the name of a library, pasted inside the front cover. It says, in effect, “this book comes from this collection”. The earliest known printed bookplates appeared in Germany in the fifteenth century, not long after European printmaking itself.<sup><a href="#source-vam-bookplates">[17]</a></sup>

The ownership mark soon became more than a label. A coat of arms, profession, favourite animal, literary character, private joke or personal motto can compress a biography into a few centimetres. This is why a bookplate often resembles a visual riddle: it describes a person through symbols.

Bookplates are still alive. Private and institutional libraries use them to mark collections, record provenance and commemorate donors or special bequests.<sup><a href="#source-loc-bookplates">[18]</a></sup> At the same time, ex libris has become an independent form of small-format graphic art. Artists make editions, collectors exchange them, museums preserve them, and international competitions exhibit them alongside other original prints. A contemporary ex libris may never be pasted into a book, yet the owner’s name, the words *Ex Libris* and its personal imagery preserve the connection with its first purpose.<sup><a href="#source-met-bookplates">[19]</a></sup>

## What do X1, L1, C3 or C3+C5 mean?

Catalogues of ex libris and small-format prints often place a short code beside the technique. It belongs to an international system first organised by the FISAE community in 1958 and revised in 2002.<sup><a href="#source-fisae-technique-codes">[20]</a></sup> The letter identifies a family of processes and the number a particular method.
...
|---|---|---|
| **C1** | Steel engraving | Lines cut with a burin into a steel plate |
| **C2** | Burin engraving | Lines cut with a burin, usually into copper |
| **C3** | Etching | Lines drawn through a ground and bitten into the plate |
| **C4** | Drypoint | Lines scratched directly into the plate |
| **C5** | Aquatint | A granular resist and mordant create areas of tone |
| **C6** | Soft-ground and related methods | Textures or a soft drawn line transferred and then bitten |
| **C7** | Mezzotint | Light areas smoothed from a previously roughened plate |
| **C8** | Other intaglio methods | Recessed printing from linoleum, plastic and other non-metal matrices |

When several processes occur in one work, their codes are joined with a plus sign. **C3+C5**, for example, means “etching and aquatint”; **C3+C5+C7** means “etching, aquatint and mezzotint”. The code does not replace the readable name of the technique. It lets the same catalogue entry be understood in Lviv, Varna, Trakai or Tokyo.
