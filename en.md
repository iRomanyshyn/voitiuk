...
**Language:** English (default) · [Українська](/uk.html) · [Deutsch](/de.html)
...
I am a Ukrainian printmaker and graphic artist. In my work, I focus on monochrome, highly detailed print techniques and visual storytelling that combines symbolic imagery, animals, and surreal narrative elements.
...
{% include social-links.html lang="en" %}
...
<form action="https://formspree.io/{{ site.formspree_form_path }}" method="POST">
  <p>
    ...
    <input id="name-en" type="text" name="name" required style="width:100%;max-width:520px;">
  </p>
  <p>
    <label for="email-en">Email</label><br>
    <input id="email-en" type="email" name="email" required style="width:100%;max-width:520px;">
  </p>
  <p>
    <label for="message-en">Message</label><br>
    <textarea id="message-en" name="message" rows="6" required style="width:100%;max-width:520px;"></textarea>
  </p>
  <input type="hidden" name="_subject" value="New message from anna voitiuk site (EN)">
